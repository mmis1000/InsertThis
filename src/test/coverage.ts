...
export function createReport(): void {
  ...
  const watermarks = {
    statements: [50, 80] satisfies [number, number],
    functions: [50, 80]  satisfies [number, number],
    branches: [50, 80]  satisfies [number, number],
    lines: [50, 80]  satisfies [number, number],
  }
